...
function FeaturedSection({ listings, onOpen, onNav }) {
  return (
    ...
    <section className="section-legacy" style={{padding:'96px 6%'}}>
      <div className="inner">
        ...
        <div className="tabs-row">
          <button className={'tab-btn legacy-tab'+(tab==='tenants'?' active':'')} onClick={()=>setTab('tenants')}>For Tenants &amp; Buyers</button>
          <button className={'tab-btn legacy-tab'+(tab==='owners'?' active':'')} onClick={()=>setTab('owners')}>For Property Owners</button>
        </div>
...
window.FiveCPromise = FiveCPromise;
window.MistOwnerBand = MistOwnerBand;

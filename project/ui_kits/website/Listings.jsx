...
function ListingsPage({ filters, onChangeFilters, onOpen }) {
  const listings = window.CA_MOCKS.listings;
      ...
      <div className="listings-wrap">
        ...
        {filtered.length === 0 ? (
          <div style={{padding:'80px 20px', textAlign:'center', color:'var(--fg-2)'}}>
            <Icon name="search" size={36} style={{color:'var(--ca-coral)', margin:'0 auto 16px'}}/>

...
export function AIConsole({ open, onOpen, onClose }) {
    ...
    <>
      {!open && (
        <div className="fab-stack">
          ...
          <a className="fab whatsapp" href="https://wa.me/918040005000" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
